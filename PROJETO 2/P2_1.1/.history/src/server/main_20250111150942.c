...
static void dispatch_threads(DIR *dir) {
  ...
  while(1){
    ...
    result = read_all(fifo_de_registo_fd, resquest_msg + 1 , sizeof(resquest_msg) - 1, NULL);
    ...
    ret = read(fifo_de_registo_fd, resquest_msg, sizeof(resquest_msg));
    switch (ret){
        ...
        case 121:
            if(resquest_msg[0] != '1'){
              printf(stderr, "Wrong OP_CODE for this pipe\n");
              continue;
            }
