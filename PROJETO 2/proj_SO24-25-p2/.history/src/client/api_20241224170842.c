...
int kvs_connect(char const* req_pipe_path, char const* resp_pipe_path, char const* server_pipe_path,
  ...
  // create pipes and connect
   ...
   strncpy(req_pipe_path, req_path, sizeof(req_pipe_path));
    strncpy(resp_pipe_path, resp_path, sizeof(resp_pipe_path));
    strncpy(notif_pipe_path, notif_path, sizeof(notif_pipe_path));
